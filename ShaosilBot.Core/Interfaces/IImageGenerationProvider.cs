...
namespace ShaosilBot.Core.Interfaces
{
	public interface IImageGenerationProvider
	{
		...
		Task<SharedEnqueueResult> EnqueuePrompt(IUserMessage message, IUser requestor, string posPrompt, string? negPrompt, int? width, int? height, string? seedStr, string? model, string? sampler, int? steps, int? cfg);
