...
namespace ShaosilBot.Core.SlashCommands
{
	public class GitBlameCommand : BaseCommand
    {
        ...
        public GitBlameCommand(ILogger<GitBlameCommand> logger, IHttpUtilities httpUtilities, IFileAccessHelper fileAccessHelper) : base(logger)
        {
...
* functions:
    ...
    - List Blameables
        ...
        public override async Task<string> HandleCommand(SlashCommandWrapper command)
        {
            ...
            var subscribers = await SimpleDiscordUserHelper.GetAndUpdateUsers(_fileAccessHelper, command.Guild, BlameablesFilename, releaseLease);
